...
namespace Mistaken.API.Patches.Vars
{
    internal static class EnableVarPatchs
    {
        public static void Patch()
        {
            ...
            PluginHandler.Instance.Harmony.Patch(typeof(ServerRoles).GetMethod(nameof(ServerRoles.UserCode_CmdSetNoclipStatus)), null, new HarmonyLib.HarmonyMethod(typeof(NoClipPatch).GetMethod(nameof(NoClipPatch.Postfix))));
        }
    }
}
