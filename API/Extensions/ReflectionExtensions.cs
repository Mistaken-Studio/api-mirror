...
public static class ReflectionExtensions
{
    ...
    {
        type.GetMethod(methodName, BindingFlags.Instance | BindingFlags.Static |
            BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.InvokeMethod)?.Invoke(null, param);
    }
    ...
    /// <summary>
    /// Gets all loadable types from specified <see cref="Assembly"/>.
    /// </summary>
    /// <param name="assembly">Assembly.</param>
    /// <returns><see cref="Type"/>[] of loadable types.</returns>
