...
namespace Mistaken.API.Extensions
{
    ...
    public static class DamageExtensions
    {
        ...
        public static bool WillDie(this MPlayer player, DamageHandlerBase handler)
        ...
        /// <param name="handler">Damage Cause.</param>
        /// <returns>If player will die because of this damage.</returns>
        public static bool WillDie(this MPlayer player, StandardDamageHandler handler)
        {
        ...
        public static float GetRealDamageAmount(this MPlayer player, StandardDamageHandler handler, out float dealtHealthDamage, out float absorbedAhpDamage)
        {
            var tmp = ((AhpStat)player.ReferenceHub.playerStats.StatModules[1])._activeProcesses.Select(x => new { Process = x, x.CurrentAmount });
            var hp = player.Health;
            var damage = handler.Damage;
        ...
        public static float GetRealDamageAmount(this MPlayer player, StandardDamageHandler handler)
